...
<head>
    ...
    <style>
        ...
        /* Navigation Links Container - Horizontal Alignment */
        .nav-bar {
            display: flex;
        ...
        /* Edit & Delete Links Inside Table */
        td a {
            display: inline-block;
            padding: 6px 12px;
            margin-right: 4px;
...
<body>
    ...
    <div class="nav-bar">
        <a href="add_product.php" class="btn-nav">เพิ่ม</a>
            ...
            foreach($result as $order){
                ...
                <tr>
                   <td><?= $order["p_id"] ?></td>
                    ...
                    <td>
                        <!-- แก้ไข -->
                        <a href="edit_product.php?id=<?= $order["p_id"] ?>">แก้ไข</a>
                        <!-- ลบ -->
                        <a href="action/delete_product.php?id=<?= $order["p_id"] ?>">ลบ</a>
                    </td>
                </tr>
                <?php
            }
